            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                    ...
                    <form class="form-validate" method="POST" action="/mitra/gantiPasswordLupa/proses">
                      {{ csrf_field() }}
                    <div class="form-group" hidden>
                        <label>Username</label>
                        <input type="text" id="username" name="username" class="form-control" placeholder="Username" value="{{$username}}" readonly>
                    </div>
