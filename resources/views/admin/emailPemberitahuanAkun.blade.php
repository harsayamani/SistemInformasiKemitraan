...
<head>
    ...
    <title>Email Informasi Akun Mitra Sistem Kemitraan LEN Industri</title>
    <style>
        /* -------------------------------------
            GLOBAL RESETS
        ------------------------------------- */
    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Informasi Akun Sistem Kemitraan</span>
                <table class="main">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="content-block powered-by">
                                Admin Sistem Kemitraan | LEN Industri
                            </td>
                        </tr>
                    </table>
                </div>
